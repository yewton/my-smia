...
resource "local_file" "env" {
  ...
  ES_HOST = "${module.elkz_ec2.private_dns}"
  LOGSTASH_HOST = "${module.elkz_ec2.private_dns}"
  KIBANA_HOST = "${module.elkz_ec2.private_dns}"
  ZIPKIN_HOST = "${module.elkz_ec2.private_dns}"
